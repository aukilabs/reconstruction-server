...
```yaml
h2k:
  initiative: <kebab-name>
  phase: planning
  awaiting_human: false
  plan: plans/<kebab-name>.md
```
...
- **Approvals:** per-slice | mass-approve remaining (record choice + slice ids).

## 8. Verification record

Evidence against §5 after implementation (links, commands, results).
