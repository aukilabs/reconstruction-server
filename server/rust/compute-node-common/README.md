...
`compute-node-common` hosts the node engine and all reusable infrastructure that
...
- Run `cargo test -p compute-node-common` to exercise storage, session, and DDS
