...
def stitching_helper(
    ...
    if basic_stitch_only:
        ...
        save_manifest_json(optimized_stitch_mean_qr_poses, manifest_out_path, job_status="refined", job_progress=100)
        return (
    ...
    save_manifest_json(bundle_adjusted_mean_qr_poses, manifest_out_path, job_status="refined", job_progress=100)
